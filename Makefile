...
Physics_Sim: raylib
ifneq (,$(Physics_Sim_config))
	@echo "==== Building Physics_Sim ($(Physics_Sim_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f Physics_Sim.make config=$(Physics_Sim_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f Physics_Sim.make clean
